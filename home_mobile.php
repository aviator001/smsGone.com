...
<body style="overflow:hidden;background:#000">
	<div style="width:100%;height:auto;background:#CCC;padding:0px;box-shadow:inset 0px 0px 10px #333;" id="main_content">
		<table border=0 align=center style="padding:10px;width:100%;margin-left:auto;margin-right:auto;margin-top:10px">
			<tr>
				<td style="width:10%" align=center>
					<img id="i0"  src="img/bt2.png" style="width:100px;cursor:mouse;cursor:pointer">
				...
				<td style="width:100%" align=left>
					<table width=100%>
						<tr>
							...
							<td valign=center >
								<div style="width:100%;text-shadow: 1px 1px 1px #f0f0f0;color:grey;font-family:Open Sans Condensed;font-size:92px; COLOR:SILVER"><B>ENTER YOUR MESSAGE</B></div>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td align=center colspan=2>
					<div>
						<div id="alpha" contentEditable="true" style="text-shadow: 1px 1px 1px #f0f0f0;color:silver;border:1px solid lightblue;font-family:Open Sans Condensed;width:100%;height:120px;background:white;font-size:48px;text-align:left;">
							Create Message by clicking on alphabet keys
						</div>
							<br>
							<br>
						<div id="beta" style="text-shadow: 1px 1px 1px #f0f0f0;color:grey;font-family:Open Sans Condensed;font-size:72px;width:80%;height:92px;width:100%;height:auto;background:#333;">
							<?=$str;?>
						</div>
						<div>
							<table style="width:100%">
								<tr>
									<td align=center style="width:10%">
											<img id="i1" onmouseover="(this.src=='http://finggr.com/g/img/bt2.png')? this.src='img/bt2.png' : this.src='img/bt1.png'" onmouseout="(this.src=='http://finggr.com/g/img/bt2.png')?this.src='img/bt2.png':this.src='img/bt0.png'" src="img/bt0.png" style="width:100px;cursor:mouse;cursor:pointer">
									</td>
									<td style="width:90%">
										<div style="text-shadow: 1px 1px 1px #f0f0f0;color:grey;font-family:Open Sans Condensed;font-size:72px; COLOR:SILVER"><B>SET SECRET PHRASE:</B></div>
									</td>
								</tr>
								<tr>
									<td colspan=2 style="width:100%">
										<input id="key" onclick="document.all.i1.src='img/bt2.png';document.all.i2.src='img/bt0.png'" onfocus="document.all.i1.src='img/bt2.png';document.all.i2.src='img/bt0.png'"  type="text" style="width:100%;text-shadow: 1px 1px 1px #f0f0f0;color:grey;font-family:Open Sans Condensed;font-size:72px; COLOR:#333">
									</td>
								</tr>
							</table>
						</div>
						<div>
							<table style="width:100%">
								<tr>
									<td align=center style="width:10%">
											<img id="i2" onmouseover="(this.src=='http://finggr.com/g/img/bt2.png')? this.src='img/bt2.png' : this.src='img/bt1.png'" onmouseout="(this.src=='http://finggr.com/g/img/bt2.png')?this.src='img/bt2.png':this.src='img/bt0.png'" src="img/bt0.png" style="width:100px;cursor:mouse;cursor:pointer">
									</td>
									<td style="width:90%">
								...
								<tr>
									<td colspan=2 style="width:100%">
										<input id="cell" onclick="document.all.i1.src='img/bt0.png';document.all.i2.src='img/bt2.png'" onfocus="document.all.i1.src='img/bt0.png';document.all.i2.src='img/bt2.png'" type="text" style="width:100%;text-shadow: 1px 1px 1px #f0f0f0;color:grey;font-family:Open Sans Condensed;font-size:72px; COLOR:#333">
									</td>
								</tr>
							</table>
						</div>
						<br><br>
						<div>
							<input onmouseover="this.className='s2'" onmouseout="this.className='s1'" type="button" value=" E N C R Y P T " onclick="go()" style="cursor:hand;cursor:pointer;corner-radius:12px;border-radius:12px;color:silver;margin-left:auto;margin-right:auto;font-family:Open Sans Condensed;font-size:96px;width:100%;height:200px;text-shadow: 1px 1px 1px #f0f0f0" class="s1">
						</div>
