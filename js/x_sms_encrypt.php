<?
	...
	echo $display_photo = "<div style='font-size:16px; background: NONE; position: absolute; z-index: 1000000; right: 25px;top: 10px;  border-radius: 5px; border:0px solid white; padding: 10px; box-shadow:none; TEXT-ALIGN: CENTER;'><div id='one' style='width:200px'>ENCRYPTING AND SENDING THIS IMAGE</div><div id='two' style='position:absolute;z-index:10000000000;left:50px; margin-top:5px'><img src='../images/pin.png' style='width:50px'></div><div id='three' style='max-width:200px;position:absolute;top:300px'>You can send a text message to accompany this image by typing your message out. Your image is already attached and set for encrypted transport.</div><div id='four' style='margin-top:15px'>$raw_image</div><div style='margin-top:150px'><button onclick='show_hide(this)' class='btn btn-primary'><span class='fui-exit'></span><span id='five'>Hide Photo!</span></button></div></div>";
...
<html lang="en">
    <head>
		...
		-->
		<script src="http://shadowsms.com/g/aes.js"></script>
        ...
        <div class="row">
          <div class="span6 offset1">
            ...
            <p><b><font color=black>MODE</font></b> Encrypting and sending a Photo Anonymously</p>
              ...
              <button onclick="go()" class="btn btn-primary"><span class="fui-chat"></span>Send Message</button>
          </div>
        </div>
      </div>
      <!--/.container-->
